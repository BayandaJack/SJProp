        ...
        <div className="bg-white min-h-screen py-10 px-4 md:px-20">
            ...
            <div className="bg-gray-50 rounded-lg shadow p-6 mb-8">
                ...
                <form className="flex flex-col md:flex-row gap-2">
                    <input type="text" placeholder="Search by location" className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-400" />
                    <select className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-400">
                    ...
                    <input type="number" placeholder="Min Price" className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-400" />
                    <input type="number" placeholder="Max Price" className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-400" />
                    <button type="submit" className="bg-red-500 text-white font-bold py-2 px-6 rounded hover:bg-red-600 hover:cursor-pointer transition whitespace-nowrap">Apply Filters</button>
                </form>
            </div>
