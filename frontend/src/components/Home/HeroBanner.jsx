    ...
    return (
        <section className="relative h-[80vh] bg-cover bg-center text-white" style={{ backgroundImage: "url('/banner.jpeg')" }}>
            <div className="relative z-10 flex flex-col items-center justify-center h-full gap-4 p-3">
                ...
                <a href="https://www.property24.com/for-sale/agency/sj-prop/27908" className="bg-red-500 text-white font-bold py-4 px-6 rounded hover:bg-red-600 transition animate-bounce hover:animate-none">Browse Listings</a>
            </div>
        </section>
    );
}