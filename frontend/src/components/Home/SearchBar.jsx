export default function SearchBar(){
    return (
        <div className="flex items-center bg-white rounded-lg m-2 w-full max-w-md overflow-hidden">
            ...
            <button className="bg-red-500 text-white px-4 py-2 rounded-r-lg hover:bg-red-600 hover:cursor-pointer h-full transition-transform duration-150 ease-in-out active:scale-95 active:shadow-inner" type="submit">
                Search
            </button>
        </div>
    );
